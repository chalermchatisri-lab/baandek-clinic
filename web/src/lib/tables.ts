...
export const TABLES: TableConfig[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "kind", label: "แสดงผลที่", type: "select", options: ["bot", "landing", "both"], required: true, help: "bot=แชทบอทเท่านั้น, landing=หน้าเว็บเท่านั้น, both=ทั้งสองที่", listShow: true },
      { key: "description", label: "รายละเอียด", type: "textarea" },
      ...
      { key: "end_date", label: "สิ้นสุด (ว่าง = ตัดอัตโนมัติ 14 วันจากวันเริ่ม)", type: "date", listShow: true },
      { key: "display_period", label: "ช่วงแสดง (ข้อความ)", type: "text" },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "content_type", label: "ประเภทเนื้อหา", type: "select", options: ["article", "comic-story", "infographic", "video"], listShow: true },
      { key: "panel_images_folder", label: "ลิงก์รูปหลายรูป", type: "textarea", help: "ใส่ลิงก์รูปหลายรูป คั่นด้วย |" },
      { key: "body_content", label: "เนื้อหา", type: "textarea" },
      { key: "start_date", label: "เริ่ม", type: "date", listShow: true },
      { key: "end_date", label: "สิ้นสุด (ว่าง = ไม่มีวันหมด)", type: "date", listShow: true },
      { key: "priority", label: "ความสำคัญ (ยิ่งมากยิ่งขึ้นก่อน)", type: "number", min: 0, step: 1, listShow: true },
      { key: "display_order", label: "ลำดับ", type: "number", min: 0, step: 1 },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "channel", label: "แสดงผลที่", type: "select", options: ["bot", "landing", "both"], required: true, help: "bot=แชทบอทเท่านั้น, landing=หน้าเว็บเท่านั้น, both=ทั้งสองที่", listShow: true },
      { key: "description", label: "รายละเอียด", type: "textarea" },
      { key: "start_date", label: "เริ่ม (ข้อความแสดงผล)", type: "text", help: "แสดงบนหน้าเว็บ/บอทตามตัวอักษร เช่น 'เร็วๆ นี้' หรือวันที่จริง", listShow: true },
      { key: "end_date", label: "สิ้นสุด (ข้อความแสดงผล)", type: "text" },
      { key: "expire_date", label: "วันตัดออกอัตโนมัติ", type: "date", help: "ว่าง = ตัดอัตโนมัติ 14 วันหลังกรอก ระบุเองถ้าอยากให้อยู่นานกว่านั้น", listShow: true },
